...
public partial class Inicial : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex(
            name: "IX_CameraCredentials_CredentialRef",
            table: "CameraCredentials",
    ...
    {
        migrationBuilder.DropTable(name: "CameraCredentials");
        migrationBuilder.DropTable(name: "CameraEvents");
        migrationBuilder.DropTable(name: "CameraInterfaces");
        migrationBuilder.DropTable(name: "CameraTests");
